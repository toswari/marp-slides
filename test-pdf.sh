...
# Create persistent sample PDF in project
echo ""
echo "Creating sample PDF in project..."

# Create the source file for the sample PDF
cat > /tmp/test-marp-final.md << 'EOFMD'
---
marp: true
theme: default
paginate: true
...
npx @marp-team/marp-cli /tmp/test-marp-final.md --pdf --html --allow-local-files -o examples/marp_unit-test.pdf 2>&1 | grep -E "INFO"

# Also create the markdown source in examples/
cp /tmp/test-marp-final.md examples/marp_unit-test.md
rm -f /tmp/test-marp-final.md

echo "  ✓ examples/marp_unit-test.pdf created"
echo "  ✓ examples/marp_unit-test.md created"
